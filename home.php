        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-lg-5">
                    ...
                    <?php } else { ?>
                        <div class="d-lg-flex align-items-center d-none ms-auto">
                            ...
                            <a class="custom-btn btn" href="/login/login.php">
                ...
                <div class="d-lg-flex align-items-center d-none ms-auto">
                    ...
                    <a class="custom-btn btn" href="mailto: <?php echo $_SESSION['email']; ?>">

                        <i class="fa-solid fa-user"></i>
                    </a>

                    <a class="custom-btn btn" href="tel: <?php echo $_SESSION['phoneno']; ?>">

                        <i class="fa-solid fa-phone"></i>

                    </a>

                    <a class="custom-btn btn" href="/login/logout.php">
                ...
                <div class="col-lg-12 col-12">
                    <div class="copyright-text-wrap">
                        <p class="mb-0">
                            ...
                            For Admin login:
                            <a rel="sponsored" href="/login/Admin/adminlogin.php" target="_blank">Adminlogin</a>
                        </p>
                    </div>
                </div>
